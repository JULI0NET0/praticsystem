  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '20px' }}>
        ...
        <div className="glass-card" style={{ padding: '24px', background: 'var(--color-danger-wash)' }}>
          ...
          <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--color-danger)' }}>{new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(metrics.overdue)}</h3>
        </div>
      </div>
