        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <div className="responsive-grid-2" style={{ gap: "20px" }}>
            <div className="glass-card" style={{ padding: "28px" }}>
              ...
              {[
                { label: "Previsto", value: faturamentoPrevisto, color: "var(--color-info)", max: Math.max(faturamentoPrevisto, despesas, 1) },
            ...
            <div className="glass-card" style={{ padding: "28px" }}>
              ...
              {(() => {
                ...
                const catColors: Record<string, string> = { pro_labore: "#A78BFA", funcionario_pj: "var(--color-info)", sistema: "var(--color-success)", internet: "var(--color-warning)", taxa_asaas: "#FB923C", taxa_boleto: "#F472B6", taxa_mensageria: "var(--color-info)", outros: "var(--text-secondary)" };
