...
import { Plus, Search, Shield, User as UserIcon, ShieldAlert, MoreVertical, AtSign, Loader2 } from "lucide-react";
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          ...
          <Link href="/admin/users/create">
            <Spotlight as="button" className="btn btn-accent"><Plus size={18} /> Convidar Usuário</Spotlight>
          </Link>
        </div>
      </div>
