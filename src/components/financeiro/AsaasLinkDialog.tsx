      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        {transaction && (
          <div style={{
            ...
            background: transaction.type === "CREDIT" ? "var(--color-success-wash)" : "var(--color-danger-wash)",
            border: `1px solid ${transaction.type === "CREDIT" ? "var(--color-success-wash)" : "var(--color-danger-wash)"}`,
          }}>
            ...
            <p style={{ fontWeight: 800, fontSize: "1.05rem", color: transaction.type === "CREDIT" ? "var(--color-success)" : "var(--color-danger)", marginTop: "2px" }}>
            ...
            pendingEntries.length === 0 ? (
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "8px", flexShrink: 0 }}>
                    <span style={{ fontWeight: 700, color: "var(--color-danger)" }}>−{formatCurrency(Number(entry.amount))}</span>
                    {isSelected && <Check size={14} color="var(--accent)" />}
                  </div>
                </button>
              );
